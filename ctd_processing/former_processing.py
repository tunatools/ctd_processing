...
class CtdProcessing:
    ...
    def run_seabird(self):
        ...
        self.modify_cnv_file_object = former_cnv.CNVfile(cnv_down_file_path, ctd_processing_object=self)
...
class SetupFile:
    ...
    def _set_paths(self):
        ...
        self.paths['cnv_down'] = Path(self.woirking_directory, f'd{self.new_file_stem}.cnv')
